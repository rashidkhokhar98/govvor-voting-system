 ...
 */
 ...
 export function GovernomentPage() {
   ...
   const handleCategoryItem = (info, bill) => {
     setCard({info, bill});
     setCardShow(true);
   };
       ...
       <div className="cntainer-fluid row">
         ...
         >
           ...
           <div className="row d-flex bg-light mt-5  mx-auto">
             ...
             {kingInfo && (
               <div onClick={() => handleCategoryItem(kingInfo, govt.king)}>
                 <Card
             ...
             {pmInfo && (
               <div onClick={() => handleCategoryItem(pmInfo, govt.pm)}>
                 <Card
                   className=" mr-3 mb-3 shadow"
                   style={{
                     width: '14rem',
             ...
             {senatorInfo && (
               <div onClick={() => handleCategoryItem(senatorInfo, govt.senator)}>
                 <Card
                   className=" mr-3 mb-3 shadow"
                   style={{
                     width: '14rem',
             ...
             {mayerInfo && (
               <div onClick={() => handleCategoryItem(mayerInfo, govt.mayer)}>
                 <Card
                   className=" mr-3 mb-3 shadow"
                   style={{
                     width: '14rem',
           ...
           >
             <Modal.Header>
               <Modal.Title id="contained-modal-title-vcenter">
                 <strong> {card && card.info.fullName}</strong>{' '}
                 <small>
                   (SELECTED {card && card.info.role} OF THE WEEK!)
                 </small>
               </Modal.Title>
                     ...
                     <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mx-auto px-auto pb-2 pt-2">
                       <div className="row mx-auto">
                         <div className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-2 text-center">
                           <table>
                             <tbody>
                               ...
                               <tr>
                                 <td>
                                   <small>{card.info.fullName}</small>
                                 </td>
                               </tr>
 
                               <tr>
                                 <td>
                                   <small>{card.info.role}</small>
                                 </td>
                               </tr>
                               <tr>
                                 <td>
                                   <small>Votes:{card.bill.vote}</small>
                                 </td>
                               </tr>
                             </tbody>
                           </table>
                         ...
                         <div className="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-10 text-justify">
                           ...
                           <h4>Bill Number:{card.bill.billNumber}</h4>
                           <p>{card.bill.billDescription}</p>
                         </div>
                       </div>
                     </div>
                   )}
